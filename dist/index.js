...
function parseRichText(rt) {
    ...
    if (type === 'text') {
        ...
        const url = (_a = text.link) === null || _a === void 0 ? void 0 : _a.url;
...
function createMarkdownFile(notion, page) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const page_blocks = yield notion.blocks.children.list({
            block_id: page.id
        });
        for (const block of page_blocks.results) {
            switch (block.type) {
                ...
                case 'image':
                    ...
                    const caption = ((image === null || image === void 0 ? void 0 : image.caption) && image.caption[0].plain_text) || '';
...
function genMarkdown(notionApiKey, database_id) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            do {
                const res = yield notion.databases.query({
                    database_id,
                    start_cursor
                });
                const pages = res.results;
                for (const p of pages) {
                    const createdFileName = yield createMarkdownFile(notion, p);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core = __importStar(__nccwpck_require__(186));
const genMarkdown_1 = __nccwpck_require__(156);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield genMarkdown_1.genMarkdown(NOTION_API_KEY, NOTION_DATABASE_ID);
            return;
        }
        catch (error) {
...
const api_endpoints_1 = __nccwpck_require__(605);
...
var http = _interopDefault(__nccwpck_require__(876));
